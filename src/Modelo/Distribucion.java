...
// Nota: Se asume que esta entidad solo guarda los IDs de las claves foráneas
// para simplificar el mapeo a la base de datos.

public class Distribucion {

    private int idDistribucion;
    private int idProductoAlmacenado; // FK al producto que se distribuye
    private double cantidad;
    private String destino;
    private String fechaDistribucion;
    private int idTrabajadorResponsable; // FK al trabajador responsable

    public Distribucion() {
    }

    public Distribucion(int idDistribucion, int idProductoAlmacenado, double cantidad, String destino, String fechaDistribucion, int idTrabajadorResponsable) {
